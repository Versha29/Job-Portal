...
public class ResumeBuilder extends HttpServlet
{
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException
    {
        try
        {
            ...
            float font_size=20;
            int style=Font.BOLD;
            Paragraph title=new Paragraph("RESUME", FontFactory.getFont(font_name, font_size, style, BaseColor.BLUE));
            document.add(title);
            //------------------------------------------
            ...
            int co_style=Font.PLAIN;
            Paragraph careertitle=new Paragraph("CARRIER OBJECTIVE", FontFactory.getFont(co_font_name, co_font_size, co_style, BaseColor.BLUE));
            ...
            Paragraph eduquatitle=new Paragraph("EDUCATIONAL QUALIFICATION", FontFactory.getFont(co_font_name, co_font_size, co_style, BaseColor.BLUE));
            ...
            PdfPCell exc2=new PdfPCell(new Phrase("Company"));
            table2.addCell(exc2);
            
            PdfPCell exc3=new PdfPCell(new Phrase("Location"));
            table2.addCell(exc3);
            
            PdfPCell exc4=new PdfPCell(new Phrase("Job Title"));
            table2.addCell(exc4);
            ...
            //------------skills-------------
            Paragraph skills=new Paragraph("SKILLS", FontFactory.getFont(co_font_name, co_font_size, co_style, BaseColor.BLUE));
            document.add(skills);
            
            Paragraph myskills=new Paragraph(skills2);
            ...
            document.add(langpro);
             Paragraph contact=new Paragraph("Contact No. : "+contact2);
            ...
            Paragraph mydescl=new Paragraph("I do hereby declare that the particulars given herein are true to best of my knowledge and belief.I will be responsible for any descripencies found in the above information.");
